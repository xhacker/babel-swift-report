...
Finally, we convert all the test cases by hand. If the machine-converted code is \emph{identical} to the hand-converted one, we say that the conversion is \emph{optimal}. We define two pieces of code are \emph{identical} if they have the same parse tree. Table \ref{table:quality} shows the quality of converted code for each conversion tool.
...
\textbf{Code Piece} & Babel Swift & objc2swift & Swiftify & iSwift \\
\hline
dispatch        & Not Optimal & n/a & Not Optimal & No  \\
location        & Optimal & n/a & Not Optimal & n/a \\
prepareforsegue & Optimal & n/a & Not Optimal & n/a \\
sortusingblock  & n/a & n/a & Optimal & n/a \\
textfield       & n/a & n/a & Optimal & n/a \\
viewwillappear  & Optimal & n/a & Not Optimal & n/a \\
\hline
\end{tabular}
\end{center}

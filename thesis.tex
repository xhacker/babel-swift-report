...
Considering there are a lot of Objective-C code on Apple platforms, there is a high demand for Objective-C to Swift conversion tools. \emph{objc2swift} \cite{objc2swift} is an open-source conversion tool. \emph{Swiftify} \cite{swiftify} and \emph{iSwift} \cite{iswift} are two commercial conversion tools.
